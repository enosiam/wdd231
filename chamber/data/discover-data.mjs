// discover-data.mjs
// Export an array of 8 items of interest for the Discover page.
// Each item includes: id, title, address, description, image (relative to /images), and optionally a url.
const items = [
  {
    "id": 1,
